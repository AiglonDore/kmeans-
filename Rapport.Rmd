...
all observations are grouped by species. They seems to share common values regarding their sepals.\par
But this distinction is not that marked for the petals: irises seems to have more common aspects, regarding the population ellipses, even if their species are different.
...
Using this correlation plot, we notice that
